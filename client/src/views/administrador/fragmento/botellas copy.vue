<template>
  <div id="printCanvas2">
    <GridLayout :layout="printData" :style="{ 'margin-top': -marginH + 'px' }" :is-draggable="false"
      :is-resizable="false" :autoSize="true" :row-height=cellH :col-num="4" :margin="[marginW, marginH]"
      :use-css-transforms="true">
      <GridItem v-for="item in printData" style="text-align: center; border: solid 1px gray; color: black;"
        :static="item.static" :key="item.traceCode" :x="item.x" :y="item.y" :w="1" :h="1" :i="item.traceCode">
